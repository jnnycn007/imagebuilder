...
rockchip_rk33xx_release_version="6.18.22-stb-rkc%2B"
...
rockchip_rk33xx_uboot_ddrbin_spl_version="260420-05"
rockchip_rk33xx_uboot_ddrbin_666mhz_spl_version="260420-05"
rockchip_rk33xx_uboot_ddrbin_v116_spl_version="260420-05"
...
wget -v https://github.com/hexdump0815/u-boot-misc/releases/download/${rockchip_rk33xx_uboot_ddrbin_spl_version}/boot-rk3328-ddrbin-v1.15-spl-aarch64.dd.gz -O - | gunzip -c > ${DOWNLOAD_DIR}/boot-rockchip_rk33xx-${2}.dd
